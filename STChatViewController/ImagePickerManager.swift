...
class ImagePickerManager: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var alert = UIAlertController(title: "Select Source", message: nil, preferredStyle: .actionSheet)
    ...
    func openCamera(){
        ...
        if(UIImagePickerController .isSourceTypeAvailable(.camera)){
            ...
            let alertWarning = UIAlertController(title: nil, message: "You don't have camera", preferredStyle: .alert)
